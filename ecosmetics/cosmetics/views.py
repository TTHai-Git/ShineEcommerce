...
class OriginsViewSet(viewsets.ViewSet, viewsets.generics.ListAPIView):
...
class TagViewSet(viewsets.ViewSet, viewsets.generics.ListAPIView):
    queryset = Tag.objects.all()
    serializer_class = serializers.TagSerializer
    pagination_class = paginators.TagPaginator


class CommentViewSet(viewsets.ViewSet, viewsets.generics.ListAPIView):
    queryset = Comment.objects.all()
    serializer_class = serializers.CommentSerializer
    pagination_class = paginators.CommentPaginator


class NotificationViewSet(viewsets.ViewSet, viewsets.generics.ListAPIView):
    ...
    def load_new_blogs(self, request, pk=None):
        ...
        blogs = Notification.objects.filter(type="Blog").order_by('-id')
        for blog in blogs:
            results.append({
                "blog_id": blog.id,
        ...
        page = paginator.paginate_queryset(results, request)
        serializer = serializers.BlogSerializer(page, many=True)
        return paginator.get_paginated_response(serializer.data)


class ProductViewSet(viewsets.ViewSet, viewsets.generics.ListAPIView, viewsets.generics.CreateAPIView):
